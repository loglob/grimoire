...
%
% When a unit is required, an abbreviaiton macro (i.e. \gr) or literal unit string (i.e. [g]) is allowed.
...
% - one \grVariants
% - one \grConversion (preceded by a \grDeclareVariants)
...
% #1 - A number followed by a unit, or just a number
\newcommand{\grUnit}[1]{#1}
